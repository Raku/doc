...
C<.keys> is undefined nor is one anonymous list ever L<===> to another.
...
which is something that binding is great at keeping track of but which assignment doesn't
concern itself much.
