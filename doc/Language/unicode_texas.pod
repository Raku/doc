...
Any codepoint that has the L<Nd> property, can be used as a digit in any
...
that has the L<Zs>, L<Zl> or L<Zp> property.

=head1 Numeric values

Any codepoint that has the L<No> property, can be used as a numeric value,
such as ½ and ⅓.
