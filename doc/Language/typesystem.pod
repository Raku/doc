...
=head4 Forward Attributes in Constructors

Often one class will instanciate another class while sharing attribute names.
There is a shortcut for calling named parameter aliases in this case. Instead
of writing C<:attr($.attr)> use C<:$.attr>.
