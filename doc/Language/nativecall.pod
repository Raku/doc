...
This will I<cast> the L<Pointer> C<$source> to  an object of C<$target-type>.
...
originally developed) hosts L<various examples|https://github.com/jnthn/zavolaj/tree/master/examples>
