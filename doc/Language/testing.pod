...
=item ok($value, $description?), nok($condition, $description?)
...
=item isnt($value, $expected, $description?)
...
=item is-approx($value, $expected, $description?)
...
=item is-deeply($value, $expected, $description?)
...
=item cmp-ok($value, $comparison, $expected, $description?)
...
=item isa-ok($value, $expected-type, $description?)
...
=item like($value, $expected-regex, $description?)
...
=item unlike($value, $expected-regex, $description?)
...
=item eval-dies-ok($string, $description?)
...
=item eval-lives-ok($string, $description?)
...
=item throws-like($code, $expected-exception, $description?)
