        ...
        if(window.localStorage){
            ...
            if ( ! sS.getItem(commit+window.location.pathname) ) {
                ...
                function report_broken_link(url) {
                    $('html').find('#search').after('<div style="text-align: center;">Broken link: ' + url + ' found. Please report at <a href="https://webchat.freenode.net/?channels=#raku">irc.freenode.net#perl6</a></div>');
                }
