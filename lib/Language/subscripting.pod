...
Often one wants to refer to a specific element (or specific slice of elements)
of a collection or data structure. Borrowing from mathematical notation where
one would use I<v₁, v₂, v₃> to refer to the components of a vercor I<v>, this
...
...
=comment TODO: Provide a basic intro to subscripting. Don't forget to mention:
    - .<> as syntactic sugar for .{}
    - .[] on non-positionals being treated like a list of 1 element
...
Delete the element from the collection, in addition to returning its value.
    ...
    my @tens = 0, 10, 20, 30, 40;
    dd @tens[1]:delete;     #-> 10
    dd @tens[2, 4]:delete;  #-> (20, 40)
    dd @tens;               #-> [0, 20]<>
    
    my %fruit = apple => 5, orange => 10;
