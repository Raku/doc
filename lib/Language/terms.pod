...
are actually a powerful sub-language of Perl 6. See L<Quoting Constructs>.
...
These forms produce regex literals. See L<Quoting Constructs>.
...
Returns an L<Int> representing the current time.
