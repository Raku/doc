...
which this document describes in L<#Set/Bag Operators>.
...
C<{ }> postcircumfix, and always have a value of either C<True> or C<False>. For an
immutable collection, see L<Set>.
...
integers, and can be accessed with the C<{ }> postcircumfix. For an
immutable collection of integrally weighted values, see L<Bag>.
