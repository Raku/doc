...
flattened out non-itemized arrays. However, sometimes you want to preserve the
structure.
...
didn't look inside the list. If that's what you want, there is another utility
...
Other operations don't. Here is a list of a few operations that flatten:
