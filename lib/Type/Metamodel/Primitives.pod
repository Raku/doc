...
=SUBTITLE Low-level tools for working with types

    class Metamodel::Primitives is SuperClass { ... }

C<Metamodel::Primitives> provides low-leve operations for working with types,
...
L<Int|/type/Int> class to create a custom type (usually you woulc create your
