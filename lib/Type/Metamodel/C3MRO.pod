...
Returns a list of types in the method resolution order, excluding any types
that are hidden. By default, types L</type/Cool|Cool>, L</type/Any|Any> and
L</type/Mu|Mu> are hidden.
