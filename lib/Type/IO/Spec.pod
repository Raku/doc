...
=head2 method dir-sep
        ...
        method dir-sep(IO::Spec:D:)

=head2 method curdir

        method curdir(IO::Spec:D:)

=head2 method updir

        method updir(IO::Spec:D:)

=head2 method curupdir

        method curupdir(IO::Spec:D:)

=head2 method rootdir

        method rootdir(IO::Spec:D:)

=head2 method devnull

        method devnull(IO::Spec:D:)

=head2 method basename

        method basename(IO::Spec:D: Str $path)

=head2 method extension

        method extension(IO::Spec:D: Str $path)

=head2 method tmpdir

        method tmpdir(IO::Spec:D:)

=head2 method is-absolute

        method is-absolute(IO::Spec:D: Str $file )

=head2 method path

        method path(IO::Spec:D:)
